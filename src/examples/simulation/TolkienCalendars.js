...
class SimulatedTolkienCalendars extends Component {
    ...
    constructor(props) {
        ...
        if (selectedEvent) {
            currentDate = adjustDateForCurrentEvent(currentDate, selectedEvent, startDates.shire, startDates.rivendell);
        } else {
    ...
    onCalendarRulesChange(event) {
        ...
        if (selectedEvent) {
            currentDate = adjustDateForCurrentEvent(currentDate, selectedEvent, shireStartDate, rivendellStartDate);
        } else {
    ...
    render() {
        ...
        if (selectedEvent < 1) {
            let previousEvent = findPreviousEventIndex(currentDate, shireStartDate, rivendellStartDate);
