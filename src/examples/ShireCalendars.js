                ...
                <tbody>
                    ...
                    <tr>
                        <td style={CaptionCellStyle}>
                            Shire Reckoning year view with Tolkien month and
                            weekday names
                            <pre>
                                <code>
                                    {`
...
<ShireCalendar region={ShireCalendar.REGION_NAMES_TOLKIEN}
               ...
               className="shire-calendar" />
                        ...
                        <td style={CaptionCellStyle}>
                            Shire Reckoning year view with Shire month and
                            weekday names
                            <pre>
                                <code>
                                    {`
...
<ShireCalendar yearView={true}
               ...
               className="shire-calendar" />
                        ...
                        <td style={CaptionCellStyle}>
                            Shire Reckoning year view with Bree month and
                            weekday names
                            <pre>
                                <code>
                                    {`
...
<ShireCalendar region={ShireCalendar.REGION_NAMES_BREE}
               ...
               className="shire-calendar" />
                    ...
                    <tr>
                        <td style={CaptionCellStyle}>
                            Shire Reckoning horizontal view with Tolkien month
                            and weekday names
                            <pre>
                                <code>
                                    {`
...
<ShireCalendar region={ShireCalendar.REGION_NAMES_TOLKIEN}
               ...
               className="shire-calendar" />
                        ...
                        <td style={CaptionCellStyle}>
                            Shire Reckoning horizontal view with Shire month and
                            weekday names
                            <pre>
                                <code>
                                    {`
...
<ShireCalendar monthViewLayout={ShireCalendar.MONTH_VIEW_HORIZONTAL}
               ...
               className="shire-calendar" />
                        ...
                        <td style={CaptionCellStyle}>
                            Shire Reckoning horizontal view with Bree month and
                            weekday names
                            <pre>
                                <code>
                                    {`
               ...
               className="shire-calendar" />
                    ...
                    <tr id="new-year-sync">
                        <th colSpan="3" style={CaptionCellStyle}>
                            ...
                            is an example of this hypothetical alignment.
                        </th>
                    </tr>
                    <tr>
                        <td style={CaptionCellStyle}>
                            New Year's Day Sync: Shire Reckoning year view with
                            Tolkien month and weekday names
                            <pre>
                                <code>
                                    {`
JavaScript:
               ...
               className="shire-calendar" />
                    ...
                    <tr id="traditional-rules">
                        <th colSpan="3" style={CaptionCellStyle}>
                            ...
                            calendar. Since the Shire calendars were in sync
                            with the calendars of Gondor by the end of the Third
                            Age, these calendars also include a "traditional"
                            rules setting that allows the Shire calendars to
                            reckon dates according to the "traditional" leap-day
                            and leap-year rules of Gondor as described in
                            Appendix D, from any start date, which will be
                            considered the start of the Second Age in these
                            reckonings. When reckoning with these "traditional"
                            rules, the Shire calendars will also only display
                            according Shire-reform on or after T.A. 2703 (
                            ...
                            ). Note that these Shire calendars will mark Astron
                            6 and Blotmath 2 as holidays by default, but these
                            were not holidays in the Shire until after T.A.
                            3019. See the
                            <a href="https://github.com/psarando/shire-reckoning/blob/master/CHANGELOG.md#320-2018-03-25">
                                3.2.0 Changelog entry
                            </a>
                            for details on how to override a date cell's CSS
                            class (to override or unset its background color).
                        </th>
                    </tr>
                    <tr>
                        <td style={CaptionCellStyle}>
                            Traditional Shire Reckoning for T.A. 1300 (the year
                            Hobbits first settled in Bree). Year view with Bree
...
<ShireCalendar calendarRules={
               ...
               className="shire-calendar" />
                        ...
                        <td style={CaptionCellStyle}>
                            Traditional Shire Reckoning for T.A. 1601 (the year
                            Hobbits first settled in the Shire). Year view with
                            Shire month and weekday names.
                            <pre>
                                <code>
                                    {`
...
<ShireCalendar calendarRules={
               ...
               className="shire-calendar" />
                        ...
                        <td style={CaptionCellStyle}>
                            Traditional Shire Reckoning for T.A. 3019 (date of
                            the destruction of the One Ring). Year view with
                            Tolkien month and weekday names.
                            <pre>
                                <code>
                                    {`
