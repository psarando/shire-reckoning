...
const findRivendellSyncIndex = (rivendellStartDate, rivendellCalendarRules) => {
    let rivendellSyncScheme = SyncRivendellCalendar.findIndex(syncScheme => (
...
const adjustRivendellAprilSyncScheme = (shireStartDate, rivendellStartDate, rivendellSyncScheme) => {
    const rivendellAprilSyncScheme = SyncRivendellCalendar[3];
    rivendellAprilSyncScheme.startDate = new Date(rivendellAprilSyncScheme.startDate);
    rivendellAprilSyncScheme.startDate.setDate(25 + shireStartDate.getDate() - 21);

    if (SyncRivendellCalendar[rivendellSyncScheme] === rivendellAprilSyncScheme) {
...
class TolkienCalendarsExample extends Component {
    ...
    constructor(props) {
        ...
        const shireSyncScheme = props.shireSyncScheme > 0 ? props.shireSyncScheme : 1;
        ...
        const rivendellSyncScheme    = props.rivendellSyncScheme > 0 ? props.rivendellSyncScheme : 1;
        ...
        this.onGondorLeftStartDateChange  = this.onGondorLeftStartDateChange.bind(this);
        this.onGondorRightStartDateChange = this.onGondorRightStartDateChange.bind(this);
    ...
    onShireSyncChange(event) {
        ...
        if (shireSyncScheme > 0) {
            ...
            rivendellStartDate = adjustRivendellAprilSyncScheme(shireStartDate,
                                                                rivendellStartDate,
                                                                rivendellSyncScheme);
        }
    ...
    onShireStartDateChange(shireStartDate) {
        ...
        this.adjustShireSyncScheme(shireStartDate, gondorLeftStartDate, gondorRightStartDate);
    }
    ...
    adjustShireSyncScheme(shireStartDate, gondorLeftStartDate, gondorRightStartDate) {
        let shireSyncScheme = SyncShireCalendar.findIndex(syncScheme => (
            syncScheme.startDate &&
    ...
    onRivendellStartDateChange(rivendellStartDate) {
        ...
        const rivendellSyncScheme = findRivendellSyncIndex(rivendellStartDate, rivendellCalendarRules);
    ...
    onRivendellRulesChange(event) {
        ...
        const rivendellSyncScheme = findRivendellSyncIndex(this.state.rivendellStartDate, rivendellCalendarRules);
            ...
            <table>
                ...
                <tr>
                    ...
                    <th className="sync-calendar-controls" >
                        Synchronize
                        <br/>
                        <select value={rivendellSyncScheme}
                                onChange={this.onRivendellSyncChange} >
                            {SyncRivendellCalendar.map(function (sync, i) {
                                return (
                                    <option key={i} value={i}>
                                        {sync.subtitle ? `${sync.label} (${sync.subtitle}).` : sync.label}
                                    </option>
                                );
                            })}
                        </select>
                ...
                <tr>
                    ...
                    <td style={CalendarCellStyle} className={rivendellCellClassName}>
                        <RivendellCalendarWithControls caption={true}
                                                       ...
                                                       onCalendarRulesChange={this.onRivendellRulesChange}
                ...
                <tr>
                    <td style={CalendarCellStyle}>
                        <GondorCalendarWithControls caption={true}
                                                    ...
                                                    onCalendarStartChange={this.onGondorLeftStartDateChange}
                    ...
                    <td style={CalendarCellStyle}>
                        <GondorCalendarWithControls caption={true}
                                                    ...
                                                    onCalendarStartChange={this.onGondorRightStartDateChange}
